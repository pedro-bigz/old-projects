...
class FillPermissionsForPublicacao extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPublicacao constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.publicacao',
            'admin.publicacao.index',
            'admin.publicacao.create',
            'admin.publicacao.show',
            'admin.publicacao.edit',
            'admin.publicacao.delete',
            'admin.publicacao.bulk-delete',
        ]);
