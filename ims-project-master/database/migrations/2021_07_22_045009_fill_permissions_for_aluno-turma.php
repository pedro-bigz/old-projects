...
class FillPermissionsForAlunoTurma extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAlunoTurma constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.aluno-turma',
            'admin.aluno-turma.index',
            'admin.aluno-turma.create',
            'admin.aluno-turma.show',
            'admin.aluno-turma.edit',
            'admin.aluno-turma.delete',
            'admin.aluno-turma.bulk-delete',
        ]);
