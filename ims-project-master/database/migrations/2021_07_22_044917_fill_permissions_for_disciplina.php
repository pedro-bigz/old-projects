...
class FillPermissionsForDisciplina extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDisciplina constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.disciplina',
            'admin.disciplina.index',
            'admin.disciplina.create',
            'admin.disciplina.show',
            'admin.disciplina.edit',
            'admin.disciplina.delete',
            'admin.disciplina.bulk-delete',
        ]);
