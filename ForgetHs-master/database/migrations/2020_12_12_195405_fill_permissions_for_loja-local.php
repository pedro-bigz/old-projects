...
class FillPermissionsForLojaLocal extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLojaLocal constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.loja-local',
            'admin.loja-local.index',
            'admin.loja-local.create',
            'admin.loja-local.show',
            'admin.loja-local.edit',
            'admin.loja-local.delete',
            'admin.loja-local.bulk-delete',
        ]);
