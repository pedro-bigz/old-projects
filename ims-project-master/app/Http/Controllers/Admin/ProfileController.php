...
class ProfileController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('ava/profile'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }
    ...
    public function updatePassword(Request $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('ava/password'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }
